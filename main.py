...
def alarmclock(alarmtime): 
    while True:
        ...
        if time_now==alarmtime:
            ...
            text="Wake up!IT'S TIME UP NOW ",bg="DodgerBlue2",fg="white").grid(row=6,columnspan=3)
            print("wake up!")
            mixer.init()
            mixer.music.load(r'C:\Users\sonam\Downloads\Alarm Clock_alarm.wav')
            mixer.music.play()
            break
...
greet=Label(root, font = ('arial', 12 , 'italic'),
